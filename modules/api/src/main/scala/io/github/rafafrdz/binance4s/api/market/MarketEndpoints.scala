...
case class AggTradesReq(symbol: String, fromId: Option[Long] = None, startTime: Option[Long] = None, endTime: Option[Long] = None, limit: Option[Int] = None)
case class KlinesReq(symbol: String, interval: KlineInterval, startTime: Option[Long] = None, endTime: Option[Long] = None, limit: Option[Int] = None)
case class UiKlinesReq(symbol: String, interval: KlineInterval, startTime: Option[Long] = None, endTime: Option[Long] = None, limit: Option[Int] = None)
...
case class RollingTickerReq(symbol: Option[String] = None, symbols: Option[List[String]] = None, windowSize: Option[String] = None)
...
given BinanceEndpoint[AggTradesReq, List[AggTrade]] with
  ...
  def queryParams(req: AggTradesReq) =
    QueryString.empty.add("symbol", req.symbol)
      .addOpt("fromId", req.fromId).addOpt("startTime", req.startTime)
...
given BinanceEndpoint[KlinesReq, List[Kline]] with
  ...
  def queryParams(req: KlinesReq) =
    QueryString.empty.add("symbol", req.symbol).add("interval", req.interval.value)
      .addOpt("startTime", req.startTime).addOpt("endTime", req.endTime).addOpt("limit", req.limit)
...
given BinanceEndpoint[Ticker24hReq, List[Ticker24h]] with
  ...
  def queryParams(req: Ticker24hReq) =
    QueryString.empty.addOpt("symbol", req.symbol)
