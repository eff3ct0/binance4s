...
case class OrderStatusReq(symbol: String, orderId: Option[Long] = None, origClientOrderId: Option[String] = None, recvWindow: Option[Long] = None)
case class OpenOrdersReq(symbol: Option[String] = None, recvWindow: Option[Long] = None)
case class AllOrdersReq(symbol: String, orderId: Option[Long] = None, startTime: Option[Long] = None, endTime: Option[Long] = None, limit: Option[Int] = None, recvWindow: Option[Long] = None)
case class OrderListStatusReq(orderListId: Option[Long] = None, origClientOrderId: Option[String] = None, recvWindow: Option[Long] = None)
case class AllOrderListReq(fromId: Option[Long] = None, startTime: Option[Long] = None, endTime: Option[Long] = None, limit: Option[Int] = None, recvWindow: Option[Long] = None)
case class OpenOrderListReq(recvWindow: Option[Long] = None)
case class MyTradesReq(symbol: String, orderId: Option[Long] = None, startTime: Option[Long] = None, endTime: Option[Long] = None, fromId: Option[Long] = None, limit: Option[Int] = None, recvWindow: Option[Long] = None)
case class RateLimitOrderReq(recvWindow: Option[Long] = None)
case class PreventedMatchesReq(symbol: String, preventedMatchId: Option[Long] = None, orderId: Option[Long] = None, fromPreventedMatchId: Option[Long] = None, limit: Option[Int] = None, recvWindow: Option[Long] = None)
case class AllocationsReq(symbol: String, startTime: Option[Long] = None, endTime: Option[Long] = None, fromAllocationId: Option[Long] = None, limit: Option[Int] = None, orderId: Option[Long] = None, recvWindow: Option[Long] = None)
...
given BinanceEndpoint[AllOrdersReq, List[OrderInfo]] with
  ...
  def queryParams(req: AllOrdersReq) =
    QueryString.empty.add("symbol", req.symbol)
      .addOpt("orderId", req.orderId).addOpt("startTime", req.startTime)
      .addOpt("endTime", req.endTime).addOpt("limit", req.limit)
      .addOpt("recvWindow", req.recvWindow)
  def decoder = Decoder[List[OrderInfo]]
  override def weight = 20
...
given BinanceEndpoint[OrderListStatusReq, OrderListResponse] with
  ...
  def queryParams(req: OrderListStatusReq) =
    QueryString.empty.addOpt("orderListId", req.orderListId)
...
given BinanceEndpoint[AllOrderListReq, List[OrderListResponse]] with
  ...
  def queryParams(req: AllOrderListReq) =
    QueryString.empty.addOpt("fromId", req.fromId)
...
given BinanceEndpoint[MyTradesReq, List[MyTrade]] with
  ...
  def queryParams(req: MyTradesReq) =
    QueryString.empty.add("symbol", req.symbol)
      .addOpt("orderId", req.orderId).addOpt("startTime", req.startTime)
      .addOpt("endTime", req.endTime).addOpt("fromId", req.fromId)
      .addOpt("limit", req.limit).addOpt("recvWindow", req.recvWindow)
...
given BinanceEndpoint[PreventedMatchesReq, List[PreventedMatch]] with
  ...
  def queryParams(req: PreventedMatchesReq) =
    QueryString.empty.add("symbol", req.symbol)
      .addOpt("preventedMatchId", req.preventedMatchId).addOpt("orderId", req.orderId)
      .addOpt("fromPreventedMatchId", req.fromPreventedMatchId).addOpt("limit", req.limit)
      .addOpt("recvWindow", req.recvWindow)
...
given BinanceEndpoint[AllocationsReq, List[SorAllocation]] with
  ...
  def queryParams(req: AllocationsReq) =
    QueryString.empty.add("symbol", req.symbol)
      .addOpt("startTime", req.startTime).addOpt("endTime", req.endTime)
      .addOpt("fromAllocationId", req.fromAllocationId).addOpt("limit", req.limit)
      .addOpt("orderId", req.orderId).addOpt("recvWindow", req.recvWindow)
