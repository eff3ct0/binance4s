...
case class NewOrderReq(
    ...
    timeInForce: Option[TimeInForce] = None, quantity: Option[BigDecimal] = None,
    quoteOrderQty: Option[BigDecimal] = None, price: Option[BigDecimal] = None,
    newClientOrderId: Option[String] = None, stopPrice: Option[BigDecimal] = None,
    icebergQty: Option[BigDecimal] = None, newOrderRespType: Option[NewOrderRespType] = None,
...
case class CancelOrderReq(
    symbol: String, orderId: Option[Long] = None,
    origClientOrderId: Option[String] = None, recvWindow: Option[Long] = None
)
...
case class CancelReplaceOrderReq(
    ...
    cancelOrderId: Option[Long] = None, cancelOrigClientOrderId: Option[String] = None,
    timeInForce: Option[TimeInForce] = None, quantity: Option[BigDecimal] = None,
    price: Option[BigDecimal] = None, stopPrice: Option[BigDecimal] = None,
    recvWindow: Option[Long] = None
)

case class NewOcoReq(
    symbol: String, side: OrderSide, quantity: BigDecimal,
    price: BigDecimal, stopPrice: BigDecimal,
...
case class NewOtoReq(
    symbol: String, listClientOrderId: Option[String] = None,
    workingType: String, workingSide: OrderSide, workingPrice: BigDecimal, workingQuantity: BigDecimal,
    pendingType: String, pendingSide: OrderSide, pendingQuantity: BigDecimal,
    pendingPrice: Option[BigDecimal] = None, recvWindow: Option[Long] = None
)

case class CancelOrderListReq(
    symbol: String, orderListId: Option[Long] = None,
    listClientOrderId: Option[String] = None, recvWindow: Option[Long] = None
)

case class SorOrderReq(
    symbol: String, side: OrderSide, `type`: OrderType,
    quantity: BigDecimal, timeInForce: Option[TimeInForce] = None,
    price: Option[BigDecimal] = None, recvWindow: Option[Long] = None
)

// Helper for building order query strings
private def orderParams(symbol: String, side: OrderSide, tpe: OrderType,
    timeInForce: Option[TimeInForce], quantity: Option[BigDecimal],
    quoteOrderQty: Option[BigDecimal], price: Option[BigDecimal],
    newClientOrderId: Option[String], stopPrice: Option[BigDecimal],
    icebergQty: Option[BigDecimal], newOrderRespType: Option[NewOrderRespType],
    recvWindow: Option[Long]): QueryString =
  QueryString.empty
    .add("symbol", symbol).add("side", side.toString).add("type", tpe.toString)
    .addOpt("timeInForce", timeInForce.map(_.toString))
    .addOpt("quantity", quantity).addOpt("quoteOrderQty", quoteOrderQty)
    .addOpt("price", price).addOpt("newClientOrderId", newClientOrderId)
    .addOpt("stopPrice", stopPrice).addOpt("icebergQty", icebergQty)
...
given BinanceEndpoint[NewOrderReq, OrderResponse] with
  ...
  def queryParams(req: NewOrderReq) =
    orderParams(req.symbol, req.side, req.`type`, req.timeInForce, req.quantity,
      req.quoteOrderQty, req.price, req.newClientOrderId, req.stopPrice,
      req.icebergQty, req.newOrderRespType, req.recvWindow)
...
given BinanceEndpoint[TestOrderReq, io.circe.Json] with
  ...
  def queryParams(req: TestOrderReq) =
    QueryString.empty
      .add("symbol", req.symbol).add("side", req.side.toString).add("type", req.`type`.toString)
      .addOpt("timeInForce", req.timeInForce.map(_.toString))
      .addOpt("quantity", req.quantity).addOpt("quoteOrderQty", req.quoteOrderQty)
      .addOpt("price", req.price).addOpt("newClientOrderId", req.newClientOrderId)
      .addOpt("stopPrice", req.stopPrice).addOpt("recvWindow", req.recvWindow)
...
given BinanceEndpoint[CancelOrderReq, CancelOrderResponse] with
  ...
  def queryParams(req: CancelOrderReq) =
    QueryString.empty.add("symbol", req.symbol)
      .addOpt("orderId", req.orderId).addOpt("origClientOrderId", req.origClientOrderId)
...
given BinanceEndpoint[CancelReplaceOrderReq, CancelReplaceResponse] with
  ...
  def queryParams(req: CancelReplaceOrderReq) =
    QueryString.empty
      ...
      .addOpt("timeInForce", req.timeInForce.map(_.toString))
      .addOpt("quantity", req.quantity).addOpt("price", req.price)
      .addOpt("stopPrice", req.stopPrice).addOpt("recvWindow", req.recvWindow)
...
given BinanceEndpoint[NewOcoReq, OrderListResponse] with
  ...
  def queryParams(req: NewOcoReq) =
    QueryString.empty
      .add("symbol", req.symbol).add("side", req.side.toString)
      .add("quantity", req.quantity).add("price", req.price).add("stopPrice", req.stopPrice)
...
given BinanceEndpoint[SorOrderReq, OrderResponse] with
  ...
  def queryParams(req: SorOrderReq) =
    QueryString.empty
      ...
      .addOpt("timeInForce", req.timeInForce.map(_.toString))
      .addOpt("price", req.price).addOpt("recvWindow", req.recvWindow)
  def decoder = Decoder[OrderResponse]
